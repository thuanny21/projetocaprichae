...
$I= "insert into cliente(nome,sobrenome,email,ddd,telefone,celular,cep,endereco,cidade,estado,bairro,pais,senha,sexo) value('$nome', '$sobrenome', '$email', '$ddd', '$telefone', '$celular', '$cep', '$endereco', '$cidade','$estado', '$bairro', '$pais', '$pais', '$senha', '$sexo')";
